...
public class MoveCardCreator : MonoBehaviour
{
    ...
    {
        MoveCard card = new MoveCard("forward", 1, new Color(1, 1, 1, 1), true, "Sprites/", "boost", 2, 300);
        return card;
    }

    public static MoveCard getBackward()
    {
        MoveCard card = new MoveCard("backward", 1, new Color(1, 1, 1, 1), true, "Sprites/", "boost", 2, 300);
        return card;
    }
    public static MoveCard getRotationRight30()
    {
        MoveCard card = new MoveCard("Rotate_Right", 30, new Color(1, 1, 1, 1), true, "Sprites/", "rotate", 2, 15);
        return card;
    }
    public static MoveCard getRotationLeft30()
    {
        MoveCard card = new MoveCard("Rotate_Left", 30, new Color(1, 1, 1, 1), true, "Sprites/", "rotate", 2, 15);
        return card;
    }

    public static MoveCard getRotationRight60()
    {
        MoveCard card = new MoveCard("Rotate_Right", 60, new Color(1, 1, 1, 1), true, "Sprites/", "rotate", 2, 30);
        return card;
    }

    public static MoveCard getRotationLeft60()
    {
        MoveCard card = new MoveCard("Rotate_Left", 60, new Color(1, 1, 1, 1), true, "Sprites/", "rotate", 2, 30);
        return card;
    }

    public static MoveCard getRotationRight90()
    {
        MoveCard card = new MoveCard("Rotate_Right", 90, new Color(1, 1, 1, 1), true, "Sprites/", "rotate", 2, 45);
        return card;
    }

    public static MoveCard getRotationLeft90()
    {
        MoveCard card = new MoveCard("Rotate_Left", 90, new Color(1, 1, 1, 1), true, "Sprites/", "rotate", 2, 45);
        return card;
    }
